const passwordInput = document.querySelector(".password-box input"),
  copyIcon = document.querySelector(".password-box .fa-copy"),
...
const generatePassword = () => {
  ...
  copyIcon.classList.replace("uil-file-check-alt", "fa-copy"); //replace icon
};
...
copyIcon.addEventListener("click", () => {
  ...
  copyIcon.classList.replace("fa-copy", "uil-file-check-alt"); //replace icon
});
